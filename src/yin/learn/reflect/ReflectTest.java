...
public class ReflectTest {
	...
	public static void userReflectConstructor() throws InstantiationException, IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException{
		/**
	...
	public static void testFiled() throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, InstantiationException, ClassNotFoundException{
		/**
		 * 成员变量的反射 Field
		 */
	...
	public static void testReflectMethod()throws Exception{
		 ...
		 */
		String startingClassName = "yin.learn.reflect.User";
		// 反射获取到 main 方法
