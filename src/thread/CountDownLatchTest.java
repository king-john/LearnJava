...
public class CountDownLatchTest {  
    ...
    // 在finishedSingal的初始化记数量通过调用finishedSingal.countDown()减少为0前调用了finishedSingal.await()的线程一直阻塞  
    ...
    public static void main(String[] args) throws InterruptedException {  
        ...
        Thread.sleep(1000);  
        System.out.println("Thread.sleep(1000)后startSingal.countDown()所有的线程被唤醒");
        startSingal.countDown();// 所有的线程被唤醒，同时开始工作.countDown 方法的线程等到计数到达零时才继续  
        finishedSingal.await();// 等待所有的线程完成!! 再进行main()方法的下一步 
        System.out.println("finishedSingal.await()等待所有的线程完成!! 再进行main()方法的下一步 ");
